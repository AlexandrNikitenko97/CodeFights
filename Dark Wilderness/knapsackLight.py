...
and the second item weighs weight2 and is worth value2. What is the total maximum value of the items you can
take with you, assuming that your max weight capacity is maxW and you can't come back for the items later?
...
def knapsackLight(value1, weight1, value2, weight2, maxW):
    ...
    if value1 > value2 and weight1 <= maxW:
        freeCapacity -= weight1
        if freeCapacity >= weight2:
            return value1 + value2
        else:
            return value1
    ...
    if value2 > value1 and weight2 <= maxW:
        freeCapacity -= weight2
        if freeCapacity >= weight1:
            return value1 + value2
        else:
            return value2
