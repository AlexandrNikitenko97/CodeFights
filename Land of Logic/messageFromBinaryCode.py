...
# find each 8 bits, convert it to binary, binary convert to int, and use chr() to convert int to char

def messageFromBinaryCode(code):
    return ''.join([chr(int(i, 2)) for i in [code[i:i+8] for i in range(0, len(code), 8)]])
