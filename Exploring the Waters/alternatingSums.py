...
The first person goes into team 1, the second goes into team 2, the third goes into team 1 again, the fourth into team 2,
and so on.
...
def alternatingSums(a):
    return [sum([a[x] for x in range(0, len(a), 2)]), sum([a[x] for x in range(1, len(a), 2)])]
